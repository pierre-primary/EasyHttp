(function (global, factory) {
  ...
  */
  ...
  easyHttp_common.bindAction("", function (resolve, reject, url) {
      _axios_0_18_0_axios.get(url).then(function (response) {
          resolve(response.data);
      }).catch(function (error) {
          reject(error);
      });
  });
  easyHttp_common.bindAction("get", function (resolve, reject, url) {
      _axios_0_18_0_axios.get(url).then(function (response) {
          resolve(response);
      }).catch(function (error) {
          reject(error);
  ...
  easyHttp_common.bindAction("post", function (resolve, reject, url) {
      _axios_0_18_0_axios.post(url).then(function (response) {
          resolve(response);
      }).catch(function (error) {
          reject(error);
      });
  ...
  //
  var ggg = new easyHttp_common("http://test.com", {
      gg: null,
