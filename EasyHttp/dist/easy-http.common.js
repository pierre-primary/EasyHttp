            ...
            },
            {
                ...
                value: function value(key) {
                    ...
                    if (key in this[src] && !(key in this[requests])) {
                        this[requests][key] = this[createRequestItem](
                            this[src][key]
                        );
                    }
...
var funcs = {
    ...
    addProcessor: function addProcessor() {
        ...
        for (
            var _len = arguments.length, _processors = Array(_len), _key = 0;
            _key < _len;
            _key++
        ) {
